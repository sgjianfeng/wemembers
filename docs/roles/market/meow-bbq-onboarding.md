...
| 代金券 / 抽奖活动 | ⏳ 规格已确认（2026-07-19）：**S$10 纯代金** 与 **抽奖三档 50/100/200 分开**；见 `docs/company/iterations/I01-pilot-two-products.md` |
...
### 推荐 A — S$10 折扣代金券（购券用，**无抽奖**）

> 大股东已确认：与抽奖活动 **各是各的**。本活动 **只开 S$10**。

| | |
|--|--|
| **路径** | `/business/campaigns/new` |
| **操作** | ① 选模板 **「折扣代金券」** ② 名称例：`Meow BBQ S$10 代金券` ③ 折扣 **20%**（实付约 S$8） ④ 面额 **只勾 S$10** ⑤ 日期约 30 天 ⑥ 创建并 **上线** |
| **期望** | `/voucher/{slug}` 可购；无即时抽奖；余额≈实付 |
| **☐** | |
...
### Step 6 — 买券抽奖活动（**三档 50 / 100 / 200**，独立于 S$10 代金）

| | |
|--|--|
| **路径** | `/business/campaigns/new` |
| **操作** | ① 选 **「梦想大奖池」** ② 名称例：`Meow BBQ 夏日抽奖` ③ 三档 **50 / 100 / 200 全开** ④ 大奖展示可先用默认 ⑤ 创建并上线 |
| **期望** | 另一条 `/voucher/{slug}`；顾客选三档之一购买；有即时小奖 + 余额 |
| **☐** | |
