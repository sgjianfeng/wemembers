...
- Name: lucky-draw.spec.ts >> 1. Merchant: Campaign & Prize Config >> 1.4 Prize pool visible in campaign detail
- Location: tests/e2e/lucky-draw.spec.ts:146:7
...
Call log:
  ...
  - waiting for locator('text=BYD Car')
...
- button "EN"
- main:
  - heading "活动管理" [level=1]
  - paragraph: 批量管理代金券和推广活动
  - link "+ 创建活动":
    - /url: /business/campaigns/new
  - paragraph: 📅
  - paragraph: 还没有活动
  - paragraph: 创建活动来批量管理代金券
- navigation:
  - link "📊 概览":
    - /url: /business
  - link "👥 会员":
