...
- Name: lucky-draw.spec.ts >> 5. Token, Settlement & Navigation >> 5.4 Staff nav has 4 tabs
- Location: tests/e2e/lucky-draw.spec.ts:535:7

# Error details

```
Error: page.goto: net::ERR_TOO_MANY_REDIRECTS at http://localhost:3000/business
Call log:
  - navigating to "http://localhost:3000/business", waiting until "load"
