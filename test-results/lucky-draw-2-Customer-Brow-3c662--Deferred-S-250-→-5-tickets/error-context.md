...
- Name: lucky-draw.spec.ts >> 2. Customer: Browse & Submit >> 2.6 Deferred: S$250 → 5 tickets
- Location: tests/e2e/lucky-draw.spec.ts:269:7
...
Locator: locator('text=已获得 5 张抽奖券')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=已获得 5 张抽奖券')
