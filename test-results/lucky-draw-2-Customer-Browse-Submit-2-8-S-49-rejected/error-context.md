...
- Name: lucky-draw.spec.ts >> 2. Customer: Browse & Submit >> 2.8 S$49 rejected
- Location: tests/e2e/lucky-draw.spec.ts:295:7
...
Call log:
  ...
  - waiting for locator('text=消费金额不足')
