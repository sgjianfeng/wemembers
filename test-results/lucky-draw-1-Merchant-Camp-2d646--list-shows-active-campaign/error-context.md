...
- Name: lucky-draw.spec.ts >> 1. Merchant: Campaign & Prize Config >> 1.6 Lucky draw list shows active campaign
- Location: tests/e2e/lucky-draw.spec.ts:156:7
...
- button "EN"
- main:
  - heading "🎰 抽奖活动" [level=1]
  - paragraph: 核销自动发券 · 店员可手动录入 · 一键开奖
  - link "+ 创建活动":
    - /url: /business/campaigns/new?type=lucky_draw
  - paragraph: 🎰
  - paragraph: 还没有抽奖活动
  - paragraph: 创建活动后，客户核销代金券即可自动获得抽奖资格
  - link "创建第一个抽奖活动":
    - /url: /business/campaigns/new?type=lucky_draw
- navigation:
  - link "📊 概览":
