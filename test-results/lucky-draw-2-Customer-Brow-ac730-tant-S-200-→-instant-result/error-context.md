...
- Name: lucky-draw.spec.ts >> 2. Customer: Browse & Submit >> 2.7 Instant: S$200 → instant result
- Location: tests/e2e/lucky-draw.spec.ts:282:7
...
Locator: locator('text=已获得 4 张抽奖券')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('text=已获得 4 张抽奖券')
...
- text: 💡 当前即时奖池 S$0.00，可抽 S$5-S$200 券，中奖率随奖池增长
- paragraph: 请填写必要字段
- button "⚡ 即时抽奖"
- button "📋 查看我的券"
