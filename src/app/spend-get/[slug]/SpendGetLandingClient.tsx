...
export function SpendGetLandingClient({
  lang,
  from,
  backHref = null,
  storePath = null,
  ...
  /**
   * 购券入口：带 from=spend-get，购券页保持满赠活动语境，不「跳戏」
   * 登录成功后仍回到带参数的购券 URL
   */
  const buyHref = withActivityBuyContext(buyPath, {
    ...
    spendGetSlug: campaign.slug || campaign.id,
    spendGetFrom: from,
    ...
    <div className="min-h-screen bg-gradient-to-b from-rose-50 via-background to-background pb-16">
      ...
      */}
      <div
        ...
        style={{ backgroundColor: FESTIVAL_RED }}
      >
        {/*
      ...
      {authOpen && (
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="spend-get-auth-title"
        >
          <button
            type="button"
